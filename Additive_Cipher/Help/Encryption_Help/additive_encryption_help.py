def text():
	...
	print("\033[1;34;40m"+"○ "+"\033[1;35;40m"+"In Encryption each Letter of Plain text is Right Shifted depending on the value of Key.\n\n"+"\033[1;34;40m"+"○ "+"\033[1;35;40m"+"The value of Key can only be from 0 to 25.\n\n"+"\033[1;34;40m"+"○ "+"\033[1;35;40m"+"Example :\n\n\tPlain Text = "'"abxy"'"\n\n\tKey = 5\n\n\tEncrypted = "'"FGCD"'"\n"+"\033[0m");
...
def Inp():
	...
	try:
		...
		if inp=="1":
			...
			from additive_encryption_help import Inp;
